export default class Auto {
    ...
    set color(color) {
        ...
        _mostrarEstado(){
        console.log(
            `El auto ${this._marca} ${this._color} del año ${
            this._modelo
        } tiene un kilometraje de ${this._kilometraje} kms y está ${this._estado}`
        );
        }
    ...
    avanzar(velocidad, tiempo){
        if(this._estado === "Apagado"){
            console.log("El auto no puede avanzar por que está apagado");
        }
        else {
